...
struct parser {
    ...
    bool parse(const std::string& raw_cmd, std::chrono::steady_clock::time_point& start_time, task* t, rtos* os); // Parses raw_cmd and populates this->commands, then returns true on success or false on failure.
